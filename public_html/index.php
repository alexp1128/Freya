...
require '../app/Freya/Freya.php';
$app = new \Freya\Freya();

/*
$mode = $app->mode;
echo '<pre>Application environment:<br>' . print_r($app->environment, true) . '</pre>';
echo '<pre>Server: ' . print_r($_SERVER, true) . '</pre>';
*/
/*

// serv2.traffic-czars.com
// Alexander-Priebes-MacBook-Pro-2.local
